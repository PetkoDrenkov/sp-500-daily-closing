...
with open("predict_2.pkl", 'wb') as reg_2:
    pickle.dump(predict_2, reg_2)
...
with open("predict_3.pkl", "wb") as reg_3:
    pickle.dump(predict_3, reg_3)
...
with open("predict_5.pkl", "wb") as reg_5:
    pickle.dump(predict_5, reg_5)
...
with open("predict_7.pkl", "wb") as reg_7:
    pickle.dump(predict_7, reg_7)
...
with open("predict_11.pkl", "wb") as reg_11:
    pickle.dump(predict_11, reg_11)
...
with open("predict_15.pkl", "wb") as reg_15:
    pickle.dump(predict_15, reg_15)
